...
adds_square_mission(vehicle.location.global_frame,25)
...
while True: 
    ...
    circuitscomplete+=1
    print "Completing circuit #%s" % circuitscomplete
...
totaltime=(land_time-start_time)/60

# print "Waypoints reached: %s " % waypointsreached
# print "Circuits complete: %s " % circuitscomplete
print "Total flight time: %s minutes" % totaltime 
